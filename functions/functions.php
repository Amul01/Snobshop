...
$con = mysqli_connect('localhost','root','','snobshop');
...
//function to get ip address of visitors
function getIp() {
...
function getPro(){
	...
	while($row_pro=mysqli_fetch_array($run_pro))
	{
		...
		<div id='single_product'>
			...
			<a href='details.php?pro_id=$pro_id' id='details'>Details </a>
...
function getBrandPro(){
	...
	if($count_brands==0){
		echo "<h2>No products were found associated with this brand</h2>";
		exit();
	}	
